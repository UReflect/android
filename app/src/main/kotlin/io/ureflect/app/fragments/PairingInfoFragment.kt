...
class PairingInfoFragment(var next: (String) -> Unit) : CoordinatorRootFragment() {
    private var triedOnce = false

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? = inflater.inflate(R.layout.fragment_pairing_info, container, false)
